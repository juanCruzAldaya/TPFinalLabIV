...
def add_contratacion(contratacion: Contratacion):
    ...
    cursor = db.cursor()
    cursor.execute("""
        INSERT INTO contrataciones (cliente_id, servicio_id, fecha_contratacion, calendario_id, domicilio, contacto, comentarios) 
        VALUES (?, ?, ?, ?, ?, ?, ?)
    """, (contratacion.cliente_id, contratacion.servicio_id, contratacion.fecha_contratacion, contratacion.calendario_id, contratacion.domicilio, contratacion.contacto, contratacion.comentarios))
    db.commit()
    cursor.close()
    db.close()
